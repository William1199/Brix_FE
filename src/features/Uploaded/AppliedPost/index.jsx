...
import PostItemApplied from "../PostItemApplied";
...
const AppliedPost = () => {
  ...
  const renderItem = ({ item, index }) => (
    <PostItemApplied item={item} index={index} />
  );
  ...
  const renderListEmpty = () => (
    ...
    >
      ...
      >
        Hiện chưa có bài đăng nào được bạn ứng tuyển
      </Text>
    </View>
  );
  ...
  useEffect(() => {
    // call api
    (async () => {
      const res = await axiosInstance.get("contractorpost/post/applied", {
        params: {
